...
- [ConvertPicto](https://convertpicto.com) 🔒 `OSS` — Converts between PNG, JPG, WebP, AVIF, GIF, BMP, ICO and SVG in the browser, alongside compression, resizing, rotation and image-to-PDF ...image-to-PDF ([source](https://github.com/shaam130/ConvertPicto)
