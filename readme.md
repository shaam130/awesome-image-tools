...
- [CloudConvert](https://cloudconvert.com) `$` — Converts between just about any...
- [Convertio](https://convertio.co) `$` — Broad format support with a simple...
- [ConvertPicto](https://convertpicto.com) 🔒 `OSS` — Converts between PNG, JPG, WebP, AVIF, GIF, BMP, ICO and SVG in the browser, alongside compression, resizing, rotation and image-to-PDF ([source](https://github.com/shaam130/ConvertPicto)).
- [ImageMagick](https://imagemagick.org) `OSS` — The command-line workhorse...
- [imgkilo — HEIC to JPG](https://imgkilo.com/convert-heic-to-jpg-online) 🔒 — Turn iPhone...
- [JXL Convert](https://jpegxlconvert.com) 🔒 `OSS` — Convert images to and from...
- [Nutilz Image Converter](https://nutilz.com/image-converter) 🔒 — Converts JPG, PNG...
